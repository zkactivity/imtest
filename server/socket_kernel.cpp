...
int hostname_to_ip (const std::string& hostname, std::string& ip) {
...
connection::connection(int sock, int foreign_port, const std::string& foreign_ip, int local_port,const std::string& local_ip) :
